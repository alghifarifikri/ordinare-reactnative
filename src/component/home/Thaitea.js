...
import { getThaitea } from '../../redux/action/Thaitea'
...
class Thaiteas extends Component {
  constructor(props) {
    super(props)
    this.state = {
      isLoading : true,
  ...
  async componentDidMount() {
    await this.props.dispatch(getThaitea())
...
const Thaitea = withNavigation (Thaiteas)
const mapStateToProps = state =>{
  return{
    thaitea : state.thaitea
  }
}

export default connect (mapStateToProps) (Thaitea)